...
/**
 * Sidebar — Slide-out navigation drawer overlaying the mobile container.
 */
const Sidebar = ({ isOpen, onClose }) => {
  return (
    <>
      ...
      {/* Panel Sidebar */}
      <div 
        className={`absolute top-0 left-0 h-full w-[80%] max-w-[300px] bg-[#FAF9F6] z-50 shadow-2xl flex flex-col transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
        {/* Header */}
        ...
        <div className="flex flex-col gap-1 px-3 py-4 shrink-0 border-b border-gray-100">
          <button className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-200 text-[#4A5568] font-medium transition-colors text-sm">
        ...
        <div className="flex-1 overflow-y-auto px-3 pb-4">
          <div className="flex flex-col gap-1">
            ...
            <button className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-200 text-gray-500 font-medium text-sm text-left line-clamp-1 truncate transition-colors">
